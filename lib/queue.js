...
Queue.preparePacket = function (_event,_this){ 
...
Queue.prototype.clearBuffer = async function (_this) {
	...
	for(var i=0; i < _this.settings.maxBuffer && _this.buff.length; i++){
		cont = true;
		var packet = Queue.preparePacket(_event, _this);
